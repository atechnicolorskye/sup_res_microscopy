...
function out = negLikelihood_5_ADiGatorGrd(x,w,y,c,baseline,one,Xt,Yt)
global ADiGator_negLikelihood_5_ADiGatorGrd
if isempty(ADiGator_negLikelihood_5_ADiGatorGrd); ADiGator_LoadData(); end
Gator1Data = ADiGator_negLikelihood_5_ADiGatorGrd.negLikelihood_5_ADiGatorGrd.Gator1Data;
...
cada1td1(Gator1Data.Index37) = cada1td1(Gator1Data.Index37) + cada1f125dx;
...
cada1f222dx = 1./cada1tf1(:).*cada1f221dx;
cada1f222 = log(cada1f221);
cada1tf1 = y(Gator1Data.Index68);
cada1f223dx = cada1tf1(:).*cada1f222dx;
...
global ADiGator_negLikelihood_5_ADiGatorGrd
ADiGator_negLikelihood_5_ADiGatorGrd = load('negLikelihood_5_ADiGatorGrd.mat');
return
end