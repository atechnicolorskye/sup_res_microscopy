...
function out = negLikelihood_8_ADiGatorGrd(x,w,y,c,baseline,one,Xt,Yt)
global ADiGator_negLikelihood_8_ADiGatorGrd
if isempty(ADiGator_negLikelihood_8_ADiGatorGrd); ADiGator_LoadData(); end
Gator1Data = ADiGator_negLikelihood_8_ADiGatorGrd.negLikelihood_8_ADiGatorGrd.Gator1Data;
...
cada1td1(Gator1Data.Index58) = cada1td1(Gator1Data.Index58) + cada1f191dx;
...
cada1f354dx = 1./cada1tf1(:).*cada1f353dx;
cada1f354 = log(cada1f353);
cada1tf1 = y(Gator1Data.Index110);
cada1f355dx = cada1tf1(:).*cada1f354dx;
cada1f355 = y.*cada1f354;
cada1td1 = cada1f177dx;
cada1td1 = cada1td1 + cada1f355dx;
cada1f356dx = cada1td1;
...
global ADiGator_negLikelihood_8_ADiGatorGrd
ADiGator_negLikelihood_8_ADiGatorGrd = load('negLikelihood_8_ADiGatorGrd.mat');
return
end