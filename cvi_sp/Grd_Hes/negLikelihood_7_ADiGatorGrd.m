...
function out = negLikelihood_7_ADiGatorGrd(x,w,y,c,baseline,one,Xt,Yt)
global ADiGator_negLikelihood_7_ADiGatorGrd
if isempty(ADiGator_negLikelihood_7_ADiGatorGrd); ADiGator_LoadData(); end
Gator1Data = ADiGator_negLikelihood_7_ADiGatorGrd.negLikelihood_7_ADiGatorGrd.Gator1Data;
...
cada1td1(Gator1Data.Index51) = cada1td1(Gator1Data.Index51) + cada1f169dx;
...
cada1f310dx = 1./cada1tf1(:).*cada1f309dx;
cada1f310 = log(cada1f309);
cada1tf1 = y(Gator1Data.Index96);
cada1f311dx = cada1tf1(:).*cada1f310dx;
...
global ADiGator_negLikelihood_7_ADiGatorGrd
ADiGator_negLikelihood_7_ADiGatorGrd = load('negLikelihood_7_ADiGatorGrd.mat');
return
end